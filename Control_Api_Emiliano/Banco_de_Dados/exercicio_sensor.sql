...
CREATE TABLE `sensor` (
  ...
  `marcaSensor` varchar(100) NOT NULL,
  `modeloSensor` varchar(100) NOT NULL,
  `enderecoip` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`codSensor`),
  UNIQUE KEY `unique_ip` (`enderecoip`),
  CONSTRAINT `tamIP` CHECK ((char_length(`enderecoip`) > 5))
...
INSERT INTO `sensor` VALUES (1,'BOSH','SONAR3','192.168.1.1'),(2,'GE','ALPHA1','192.168.1.2'),(3,'IFM','X666','192.168.1.3');
